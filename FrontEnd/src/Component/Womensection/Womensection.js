...
const Womensection = () => {
  ...
  const WomenSection1 = (item) => {
    axios.get("http://localhost:8000/Product_show/category/womens-dresses")
  ...
  const WomenSection2 = (item) => {
    axios.get("http://localhost:8000/Product_show/category/womens-shoes")
      .then(function (response) {
  ...
  const WomenSection3 = (item) => {
    axios.get("http://localhost:8000/Product_show/category/womens-watches")
      .then(function (response) {
  ...
  const WomenSection4 = (item) => {
    axios.get("http://localhost:8000/Product_show/category/womens-bags")
      .then(function (response) {
  ...
  const WomenSection5 = (item) => {
    axios.get("http://localhost:8000/Product_show/category/womens-jewellery")
      .then(function (response) {
