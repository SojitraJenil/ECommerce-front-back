    ...
    <div className="bg-body-tertiary">
      <Container>
        <Row className="py-2">
          ...
          <div class="col-md-auto col-md-center col-12 ms-md-auto me-lg-auto me-md-auto me-xl-0 text-center ms-auto" style={{zIndex:"12"}}>
            ...
            <span className="btn border-end border-start border-0">History</span>
            <Link to="/account">
            <span className="btn border-end border-start border-0">My account</span>
            </Link>
            <Link to="/admin">
            <span className="btn border-end border-start border-0">Admin Dashboard</span>
            </Link>
            {
              jwt ?<span className="btn border-end border-start border-0"><button onClick={LogoutHandler} className="btn-bg-transparent btn m-0 p-0 border-0">Logout</button> </span> : <Link to="/register">
              <span className="btn border-end border-start border-0">
                {" "}
                Register or Sign in
              </span>
